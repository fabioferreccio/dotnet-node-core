...
### Added
- **Table Row Separators**: Added `EnableRowSeparators()` method to render separator lines between data rows.
- **Robust Layout Tests**: Added comprehensive scenario tests (`TableLayoutScenarios.spec.ts`) covering fixed width, wrapping, and padding combinations.
...
### Fixed
- Repaired the issue where the help command was not displaying the help text.
