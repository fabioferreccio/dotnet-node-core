...
export interface IServiceCollection extends Array<ServiceDescriptor> {
    ...
    AddSingleton<T>(serviceType: Constructor<T>): IServiceCollection;
    AddSingleton<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): IServiceCollection;
    ...
    AddScoped<T>(serviceType: Constructor<T>): IServiceCollection;
    AddScoped<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): IServiceCollection;
    ...
    AddTransient<T>(serviceType: Constructor<T>): IServiceCollection;
    AddTransient<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): IServiceCollection;
    ...
    TryAddSingleton<T>(serviceType: Constructor<T>): CsBoolean;
    TryAddSingleton<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): CsBoolean;
    ...
    TryAddScoped<T>(serviceType: Constructor<T>): CsBoolean;
    TryAddScoped<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): CsBoolean;
    ...
    TryAddTransient<T>(serviceType: Constructor<T>): CsBoolean;
    TryAddTransient<T>(serviceType: Constructor<T>, factory: SelfBindingFactory<T>): CsBoolean;
