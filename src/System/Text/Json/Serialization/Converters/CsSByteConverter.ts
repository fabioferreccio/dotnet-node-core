...
export class CsSByteConverter extends JsonConverter<CsSByte> {
    ...
    public Read(reader: unknown, _typeToConvert: Constructor, _options: JsonSerializerOptions): CsSByte {
    ...
    public Write(writer: JsonWriter, value: CsSByte, _options: JsonSerializerOptions): void {
