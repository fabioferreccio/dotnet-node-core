...
export class CsSByteConverter extends JsonConverter<CsSByte> {
    ...
    public Read(reader: unknown, typeToConvert: Constructor, options: JsonSerializerOptions): CsSByte {
    ...
    public Write(writer: JsonWriter, value: CsSByte, options: JsonSerializerOptions): void {
