...
export class Dictionary<TKey, TValue> {
    ...
    private ValidateAndStringifyKey(key: TKey): string {
        ...
        throw new Error(`Dictionary key type ${this._keyType.name} is not supported. Only System Types with lossless string representation (CsString, CsGuid) are allowed.`);
    }
