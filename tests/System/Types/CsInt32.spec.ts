...
describe("System.Int32 (CsInt32) - Comprehensive", () => {
    ...
    // 3. Math
    test("Arithmetic", () => {
        const a = CsInt32.From(10);
        const b = CsInt32.From(5);
    ...
    test("Divide by Zero", () => {
        expect(() => CsInt32.From(10).Divide(CsInt32.From(0))).toThrow();
    });

    // 4. Comparison & Equality
    test("Equals", () => {
        const a = CsInt32.From(100);
        const b = CsInt32.From(100);
    ...
    test("CompareTo", () => {
        const a = CsInt32.From(10);
        const b = CsInt32.From(20);
        expect(a.CompareTo(b)).toBe(-1);
        expect(b.CompareTo(a)).toBe(1);
        expect(a.CompareTo(CsInt32.From(10))).toBe(0);
    ...
    // 5. ToString
    test("ToString", () => {
        expect(CsInt32.From(999).ToString()).toBe("999");
    });
});
